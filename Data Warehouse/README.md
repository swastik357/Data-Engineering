...
README.md is where we'll provide discussion on our process and decisions for this ETL pipeline.

STEPS TO RUN:

Create IAM profile and redshift cluster and enter details in dwh.cfg-->run python3 create_tables.py-->run python3 etl.py